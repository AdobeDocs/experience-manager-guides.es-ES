...
1. Seleccionar **Editar** <img alt= "Editar icono de lápiz" src="./assets/edit_pencil_icon.svg" width="25"> para abrir **Variables** editor.
...
1. Seleccionar **Añadir variable** <img alt= "Icono Agregar" src="./assets/add-icon.svg" width="25"> para agregar una variable nueva. No se puede crear una variable con el mismo nombre que una variable existente. Se muestra un error.

   >[!NOTE]
   >
   >Si no selecciona. **Añadir variable** <img alt= "Icono Agregar" src="./assets/add-icon.svg" width="25">, la variable no se crea y se agrega a la lista.
...
1. Seleccione una variable en la **Variables** panel.
1. Pase el ratón sobre la variable para ver **Opciones** y, a continuación, seleccione la **Editar** opción.
1. En el **Editar variable** , puede editar el valor predeterminado de la variable seleccionada.
...
Puede buscar y previsualizar el valor de una variable. Introduzca una cadena en el cuadro de búsqueda de **Variables** panel. Busca tanto en función del nombre de la variable como de su valor.
Puede obtener una vista previa de una variable de dos formas:

La vista previa de la variable muestra el valor predeterminado. Por ejemplo, si ha definido el valor predeterminado de la variable ProductName como &quot;Guías de Adobe Experience Manager&quot;, muestra este valor en la vista previa.

**Desde el panel Variables de la izquierda**


1. Seleccione una variable en la **Variables** panel.
1. Pase el ratón sobre la variable para ver **Opciones** y, a continuación, seleccione la **Previsualizar** opción.

![vista previa de variables desde el panel variables](assets/variables-panel-preview-default.png){width="550" align="left"}

*Previsualizar el valor predeterminado de una variable.*

**Desde el editor de variables**

1. Pase el ratón sobre la variable de la lista para ver el **Opciones** menú.
...
El nombre predeterminado de la variable es `<selected variable name>` (como &quot;ejemplo&quot;). Puede cambiar el nombre según sus necesidades.
...
1. Seleccione una variable en la **Variables** panel.
1. Pase el ratón sobre la variable para ver **Opciones** y, a continuación, seleccione la **Eliminar** opción.

**Desde el editor de variables**

1. Pase el ratón sobre la variable de la lista para ver el **Opciones** menú.
1. Seleccionar **Eliminar** opción.
...
1. Seleccionar **Configuración** <img alt= "Icono de configuración" src="./assets/settings-icon.svg" width="25"> para abrir **Configuración de conjuntos de variables** Cuadro de diálogo.
   ![configurar conjunto de variables](assets/configure-variable-set.png){width="550" align="left"}
1. Introduzca el nombre del conjunto de variables en **Nombre** columna.
1. Seleccionar **Añadir variable** <img alt= "Icono Agregar" src="./assets/add-icon.svg" width="25"> para agregar un nuevo conjunto de variables. Los conjuntos de variables se enumeran alfabéticamente.
...
Puede ver, editar y previsualizar los valores de un conjunto de variables específico. Seleccione un conjunto de variables de la lista **Conjuntos de variables** desplegable. Los valores se muestran según el conjunto de variables seleccionado.
...
Por ejemplo, para el conjunto de variables *Adobe-Conjunto1*, ha definido el valor de la variable ProductName como &quot;ProductA&quot; y, a continuación, muestra este valor en la vista previa en el editor de variables

![vista previa de variables desde el editor de variables](assets/variables-editor-preview.png){width="550" align="left"}

*Previsualice el valor que ha definido en el conjunto de variables seleccionado.*
...
1. Puede insertar la variable de dos formas:
   ...
   **Desde la barra de herramientas**
   ...
   1. En el **Variable** , seleccione el nombre de la variable para insertarla en el área de encabezado.
   ...
   1. Para reemplazar una variable, haga doble clic en el valor de la variable y seleccione otra variable en el **Variable** Cuadro de diálogo. La variable se reemplaza.


## Generar salida de PDF con variables

Puede generar la salida del PDF con los valores de diferentes variables. Antes de generar el diseño, elija un conjunto de variables entre los ajustes preestablecidos de salida **Conjunto de variables** para elegir sus valores.

![menú desplegable de conjunto de variables](assets/output-preset-variable-dropdown.png){width="550" align="left"}
...
*Genere la salida del PDF utilizando variables en el diseño de página.*
