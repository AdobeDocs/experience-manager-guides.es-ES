...
# Añadir un código de barras a la salida de PDF
...
Este tutorial le ayuda a añadir códigos de barras en la salida de PDF.
...
Modifique el archivo `layout.css` para procesar un código de barras durante la generación de PDF. Se admiten varios tipos de código de barras como qrcode y pdf417.  Para obtener más información, vea [Tipos de código de barras](#barcode-types).
...
Puede ver el código de barras al generar el PDF de salida mediante la plantilla, que incluye el diseño de página. Una vez realizados los pasos anteriores, puede generar la salida de PDF con un código de barras.

La siguiente captura de pantalla muestra un código de barras de ejemplo en una salida de PDF.
...
Para crear un código de barras para un número de ISBN, añada un número de ISBN. A continuación, utilice el número ISBN para generar el código de barras.
...
| Código 128 | code128 | La simbología del código de barras 128 tal como se define en la norma ISO/IEC 15417:2007. |
...
| Código 93 | code93 |                            |
| Código16k | code16k |                            |
| PDF417 | pdf417 | Las simbologías de código de barras PDF417/MicroPDF417 según ISO/IEC 15438:2006 e ISO/IEC 24728:2006. |
| Código 3 de 9 | code39 | El código 3 de 9 simbología de código de barras según ISO/IEC 16388:2007. |
...
| EAN-8 | ean-8 | Simbología de código de barras EAN según BS EN 797:1996. |
| EAN-13 | ean-13 | Simbología de código de barras EAN según BS EN 797:1996. |
...
| Complemento Ean/UPC | complemento | Simbología de código de barras de complemento EAN/UPC según BS EN 797:1996. |
| Teléfono | telefonear | También conocido como Telepen Alpha. |
...
| Runas aztecas | runas aztecas | Simbología del código de barras de las runas aztecas según ISO/IEC 24778:2008 Anexo A. |
| Código azteca | aztec-code | Código Azteca simbología de código de barras Según ISO/IEC 24778:2008. |
| Matriz de datos | data-matrix | Simbología de código de barras ECC 200 de matriz de datos según ISO/IEC 16022:2006. |
