...
Esta nota de la versión cubre las instrucciones de actualización, la matriz de compatibilidad y los problemas corregidos en la versión de octubre de 2023 de Adobe Experience Manager Guides (más adelante denominada *AEM Guides as a Cloud Service*).
...
2. Actualice la propiedad `<dox.version>` en el archivo `/dox/dox.installer/pom.xml` de su código Git de Cloud Services a 2023.10.0.373.
3. Confirme los cambios y ejecute la canalización de Cloud Services para actualizar a la versión de octubre de 2023 de AEM Guides as a Cloud Service.
...
Esta sección enumera la matriz de compatibilidad para las aplicaciones de software compatibles con la versión de octubre de 2023 de AEM Guides as a Cloud Service.
...
Adobe ha identificado el siguiente problema conocido para la versión de octubre de 2023.
