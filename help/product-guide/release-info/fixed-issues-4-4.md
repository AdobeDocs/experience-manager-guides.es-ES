---
title: Notas de versión | Se han corregido problemas en la versión 4.4.0 de las Guías de Adobe Experience Manager
description: Obtenga información acerca de las correcciones de errores en la versión 4.4.0 de las guías de Adobe Experience Manager
role: Leader
...
Para obtener más información sobre las nuevas funciones y mejoras, consulte [Novedades de la versión 4.4.0](./whats-new-4-4.md).

Más información [instrucciones de actualización para la versión 4.4.0](../release-info/upgrade-instructions-4-4.md).
