---
title: Notas de versión | Instrucciones de actualización y problemas corregidos en las guías de Adobe Experience Manager, versión 2024.2.0
...
Este artículo describe las instrucciones de actualización y la matriz de compatibilidad para la versión 2024.2.0 de las guías de Adobe Experience Manager as a Cloud Service.
...
Para ver la lista de problemas que se han corregido en esta versión, consulte [Se han corregido problemas en la versión 2024.2.0](fixed-issues-2024-2-0.md).


## Matriz de compatibilidad

Esta sección enumera la matriz de compatibilidad para las aplicaciones de software compatibles con la versión 2024.2.0 de Guías de Experience Manager as a Cloud Service.
