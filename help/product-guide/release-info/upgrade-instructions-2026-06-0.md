---
title: Notas de versión | Instrucciones de actualización y problemas corregidos en la versión 2026.06.0 de Adobe Experience Manager Guides
description: Obtenga información acerca de la matriz de compatibilidad y cómo actualizar a la versión 2026.06.0 de Adobe Experience Manager Guides as a Cloud Service.
...
# Instrucciones de actualización para la versión 2026.06.0

Este artículo describe las instrucciones de actualización y la matriz de compatibilidad para la versión 2026.06.0 de Adobe Experience Manager Guides as a Cloud Service.
...
Esta sección indica la matriz de compatibilidad para las aplicaciones de software compatibles con la versión 2026.06.0 de Experience Manager Guides as a Cloud Service.

### FRAMEMAKER y FRAMEMAKER PUBLISHING SERVER

| Versión de Experience Manager Guides as a Cloud | FMPS | FrameMaker | Oxygen Author |
| --- | --- | --- | --- |
| 2026.06.0 | No compatible | 2022 o superior | 26.1 |
...
## Actualizar a la versión 2026.06.0
