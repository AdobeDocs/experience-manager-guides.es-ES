...
Para ver la lista de problemas que se han corregido en esta versión, consulte [Problemas corregidos en la versión 5.1.0 del paquete de servicio 4](../release-info/fixed-issues-5-1-0-sp4.md).

## Matriz de compatibilidad

Esta sección enumera la matriz de compatibilidad para las aplicaciones de software compatibles con el paquete de servicio 4 de Experience Manager Guides 5.1.0.

| Guías de AEM | Versión de AEM | Service Pack |
| --- | --- | --- |
| Paquete de servicio 4 (UUID) de 5.1.0 | 6.5 LTS | 1 |
| Paquete de servicio 4 (UUID) de 5.1.0 | 6.5 | 23, 22, 21 |
...
| Versión | FMPS | FM |
| --- | --- | --- |
| Paquete de servicio 4 (UUID) de 5.1.0 | Compatible | 2022 o superior |

### Conector de oxígeno

| Versión | Ventanas de conector de oxígeno | Conector de oxígeno Mac | Editar en ventanas de oxígeno | Editar en Oxygen Mac |
| --- | --- | --- |--- |--- |
| Paquete de servicio 4 (UUID) de 5.1.0 | 3.8-uuid.1 | 3.8-uuid.1 | 2,3 | 2,3 |
...
|---|---|---| ---|
| UUID del paquete de servicio 4 de 5.1.0 | 6.5 LTS | guides-components.all-1.4.1 | aemg-docs.all-1.2.0 |
| UUID del paquete de servicio 4 de 5.1.0 | 6.5 | guides-components.all-1.4.0 | aemg-docs.all-1.2.0 |
...
## Actualización a la versión 5.1.0 del paquete de servicio 4 de Experience Manager Guides

Puede actualizar fácilmente su versión actual de Experience Manager Guides a la versión 5.1.0 Service Pack 4 en **AEM 6.5** o **AEM 6.5 LTS**.
...
Antes de continuar actualizando al paquete de servicio 4 de Experience Manager Guides versión 5.1.0, debe tener en cuenta los siguientes puntos:

- Si utiliza la versión 5.1.0 o 5.1.x, puede actualizar directamente a la versión 5.1.0 Service Pack 4.
