...
![ficha de opciones de propiedades de archivo](./assets/file-properties-outputs-tab.png){width="300"}
...
![cuadro de diálogo de elementos envolventes](./assets/surround-element.png) {width="300"}
...
Experience Manager Guides también admite documentos Markdown en la publicación nativa de PDF. Esta función es útil y le ayuda a generar PDF para los archivos Markdown del mapa DITA. La compatibilidad con Markdown en la publicación nativa de PDF le ayuda a crear, administrar y compartir fácilmente sus documentos.
