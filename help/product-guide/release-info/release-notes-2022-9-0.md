---
title: Notas de versión | Adobe Experience Manager Guides as a Cloud Service, versión de septiembre de 2022
...
1. Actualice la propiedad `<dox.version>` en el archivo `/dox/dox.installer/pom.xml` de su código Git de Cloud Services a 2022.9.178.
1. Confirme los cambios y ejecute la canalización de Cloud Services para actualizar a la versión de septiembre de AEM Guides as a Cloud Service.
...
Esta sección enumera la matriz de compatibilidad para las aplicaciones de software compatibles con la versión de septiembre de 2022 de AEM Guides as a Cloud Service.
...
AEM Guides as a Cloud Service proporciona muchas mejoras y nuevas funciones en la versión de septiembre:
...
Seleccione el icono **Reemplazar** para reemplazar la ocurrencia actual y el icono **Reemplazar todo en el archivo** para reemplazar todas las ocurrencias en el archivo seleccionado.

![Buscar reemplazo en el mapa](assets/map-find-replace.png)

De forma predeterminada, las opciones **Desproteger archivo antes de reemplazar** y **Crear nueva versión después de reemplazar** están seleccionadas, de modo que se desprotege un archivo antes de reemplazar el texto y se crea una nueva versión después de reemplazar el texto.
...
Puede definir los metadatos a partir del ajuste preestablecido de salida de un mapa DITA. Puede establecer los metadatos de Título, Autor, Asunto y Palabras clave. Estos metadatos se asignan a los metadatos de las Propiedades del archivo de su PDF de salida.
...
![Metadatos en ajuste preestablecido](assets/preset-metadata.png)
...
* El panel Esquema no muestra contenido cuando se cambia del modo **Autor** al **Source**. (10319)
...
* Nuevo editor de mapas | El texto en negrita o cursiva agregado en el título del mapa no se conservará si cambiamos de **Autor** a la vista **Diseño**. (10218)
...
* El método abreviado Control + F no abre el modal de búsqueda del explorador en la consola de Assets después de instalar AEM Guides 4.1 en AEM 6.5.12. (10189)


## Problemas conocidos

Adobe ha identificado los siguientes problemas conocidos para la versión de septiembre de 2022 de AEM Guides as a Cloud Service.
