...
| **Incrustar archivos multimedia** | Seleccione esta opción para incrustar los recursos multimedia admitidos, como audio y vídeo, directamente en el PDF generado. Cuando se habilita, el contenido de vídeo se representa mediante una imagen de póster o una miniatura en PDF y se puede reproducir en visores de PDF compatibles que admitan multimedia incrustados. Para la reproducción de vídeo, abra PDF en una aplicación compatible como la última versión de Adobe Acrobat y confíe en el documento cuando se le solicite. La mayoría de los visores de PDF basados en explorador no admiten la reproducción multimedia integrada. |
...
| **Mostrar filigrana** | Seleccione esta opción para superponer una marca de agua en la salida. Puede escribir una nueva cadena de texto en el cuadro de texto con la letra mayúscula tal y como desee. <br><br>Use texto estático o variables de idioma para publicar la versión localizada de la marca de agua.  Según el idioma elegido, el valor localizado se selecciona automáticamente en la salida de PDF. Por ejemplo, puede imprimir &#39;Publisher&#39; como marca de agua en inglés y &#39;Auteure&#39; en francés.  <br> Formato: `${lng:<variable name>}`. Por ejemplo, `$ {lng:publisher-label}` donde `publisher-label` es una variable de idioma. |
