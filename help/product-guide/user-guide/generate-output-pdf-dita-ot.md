...
| Ruta de salida/Ruta de destino | La ruta dentro del repositorio de AEM donde se almacena PDF.<br>La ruta de acceso de salida se establece a través de la variable `${base_output_path}`, configurada por el administrador. Para configurar la ruta de acceso de salida, vea [Configurar la ubicación de salida base para los servicios en la nube](../native-pdf/configure-base-location-cs.md) o [Configurar la ubicación de salida base para los servicios locales](../native-pdf/configure-base-output-location.md) según los servicios que esté usando.<br> También puede usar algunas variables predeterminadas para definir la ruta de salida, ver [Usar variables para establecer las opciones Ruta de destino, Nombre de sitio o Nombre de archivo](generate-output-use-variables.md#id18BUG70K05Z). |
