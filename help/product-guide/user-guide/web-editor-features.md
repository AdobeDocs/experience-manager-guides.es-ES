---
title: Conozca las funciones del editor
description: Descubra las funciones del Editor en Adobe Experience Manager Guides. Conozca la interfaz del editor, incluida la barra de encabezado, la barra de pestañas, la barra de herramientas, el panel izquierdo, el área de edición de contenido y el panel derecho.
...
- [Información de la versión y botón Guardar como nueva versión](#save-as-new-version)
...
>[!NOTE]
>
> El modo Vista previa permite ver el documento con o sin las marcas del contenido modificado. Para obtener más información, vea el modo [Vista previa](web-editor-views.md#preview-mode-id19AAGL00163).
...
Seleccione un mapa y pulse Intro o haga doble clic para abrirlo en la **vista Mapa**. Para obtener más información, vea la descripción de la característica **Vista de mapa** en la sección [Panel izquierdo](#left-panel). Seleccione un tema y presione Intro o haga doble clic para abrirlo en el [área de edición de contenido](#content-editing-area). La posibilidad de desplazarse por un archivo y abrirlo directamente desde el Editor ahorra tiempo y aumenta la productividad.
...
Para obtener más información, vea los *atributos de visualización* en la descripción de la característica *Configuración* en la sección [Panel izquierdo](#left-panel).
...
Para ver el esquema de asunto en el panel Condiciones, el administrador del sistema debe seleccionar la opción **Mostrar esquema de asunto en el panel Condiciones** en la pestaña General de Configuración. Para obtener más información, vea la sección **Configuración** en la [barra de fichas](#tab-bar).
...
1. Seleccione el menú desplegable **Buscar en** y elija una de las siguientes opciones para realizar la búsqueda.
...
1. Puede usar el menú desplegable **Opciones** y elegir entre las siguientes opciones:
