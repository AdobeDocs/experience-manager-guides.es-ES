...
> - El tipo de referencia Vínculo web siempre inserta ámbito=`external` de forma predeterminada y agrega la dirección URL tal cual, sin ninguna modificación. Este comportamiento se aplica de forma coherente a las rutas relativas y absolutas en todos los tipos de URL admitidos, incluidos HTTP/S y FTP/S.
