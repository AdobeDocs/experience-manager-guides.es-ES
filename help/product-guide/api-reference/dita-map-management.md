...
|----|----|--------|-----------|
| `ditamap` | Cadena | Sí | Ruta absoluta del fichero de mapa DITA en el repositorio de AEM. |
...
Un método POST que inicia una exportación para un mapa DITA con todos sus dependientes, como temas referenciados, submapas, imágenes y DTD utilizados en el mapa y los temas. El estado se puede consultar más adelante y la URL de descarga se puede recuperar una vez completada.
