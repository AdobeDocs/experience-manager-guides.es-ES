...
Después de la conversión, el contenido estructurado se puede migrar a AEM Guides.  Para obtener más información, vea [Cargar contenido DITA existente](./migrate-content-upload-existing-dita-content.md).
