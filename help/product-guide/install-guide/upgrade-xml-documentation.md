...
Puede actualizar su versión actual de Experience Manager Guides a la versión 5.0.0 Service Pack 1:


- Si utiliza las versiones 5.0.0, 4.6.x, 4.6 o 4.4, puede actualizar directamente a la versión 5.0.0 Service Pack 1.
...
>[!TIP]
>
> La actualización a la versión 5.0.0 Service Pack 1 depende de la versión actual de Experience Manager Guides. Si utiliza las versiones 5.0.0, 4.6.4, 4.6.3, 4.6.1, 4.6.0 o 4.4, puede actualizar directamente a la versión 5.0.0 Service Pack 1.
...
>[!NOTE]
>
> Mientras sigue la documentación, asegúrese de que ambas propiedades (reindex=true y reindex-async=true para /oak:index/damAssetLucene) se actualicen simultáneamente mediante la operación de guardado.
