...
### Convertir los documentos de Word existentes en un documento de tipo de tema DITA

Las siguientes pestañas proporcionan instrucciones para convertir los documentos de Word existentes en un documento de tipo de tema DITA en función de la configuración de Experience Manager Guides: Cloud Service o On-Premise.
...
1. Cargue los documentos de origen de Word en esta carpeta. Para obtener información sobre cómo cargar contenido en DAM, consulte [Cargar contenido DITA existente](upload-dita-content.md#).
...
En términos generales, el proceso de conversión requiere que [Prepare los archivos InDesign para la conversión](aemg-appendix.md#id195DBF0045Z) y [Prepare el archivo de asignación para la migración de InDesign a DITA](aemg-appendix.md#id194AF0003HT). A continuación, debe seguir el procedimiento dado para ejecutar el proceso de conversión.
...
1. Cree un nodo de superposición de la carpeta `config` dentro del nodo `apps`.
   ...
   - En el elemento `mapStyle`, especifique la ubicación del archivo de asignación que contiene asignaciones para estilos de documento de InDesign a elementos DITA. La asignación predeterminada se almacena en el archivo ubicado en:
     ...
     >[!NOTE]
     >
     > Para obtener más información acerca de la estructura del archivo `stmap.adobeidml.xml` y cómo personalizarlo, consulte [Apéndice](aemg-appendix.md#id194AF0003HT).
...
1. Cargue los documentos de InDesign de origen en esta carpeta. Para obtener información sobre cómo cargar contenido en DAM, consulte [Cargar contenido DITA existente](upload-dita-content.md#).
...
### Convertir el documento XHTML existente en tema DITA

Las siguientes pestañas proporcionan instrucciones para convertir el documento XHTML existente en un tema DITA en función de la configuración de Experience Manager Guides: Cloud Service o On-Premise.
...
1. Cargue los documentos XHTML de origen en esta carpeta. Para obtener información sobre cómo cargar contenido en DAM, consulte [Cargar contenido DITA existente](upload-dita-content.md#).
...
Para convertir contenido de Adobe FrameMaker no estructurado (.fm y .book) en DITA estructurado, se puede utilizar el mecanismo de tabla de conversión de FrameMaker. El proceso se centra en la evaluación del contenido existente, mediante un enfoque basado en plantillas, y la asignación de estilos FrameMaker a DITA a través de tablas de conversión. Para obtener más información, vea [Migración de documentación técnica de no estructurada a DITA en Adobe FrameMaker](https://migrate-from-unstructured-to-dita-step-by-step-guide.meetus.adobeevents.com/).

Después de la conversión, el contenido estructurado se puede migrar a AEM Guides. Para obtener más información, vea [Cargar contenido DITA existente mediante la herramienta WebDAV y FrameMaker](./upload-dita-content.md).
...
Las siguientes pestañas proporcionan instrucciones para migrar cualquier otro documento estructurado basado en la configuración de Experience Manager Guides: Cloud Service o On-Premise.
...
1. Cargue los documentos estructurados de origen en esta carpeta. Para obtener información sobre cómo cargar contenido en DAM, consulte [Cargar contenido DITA existente](upload-dita-content.md#).
