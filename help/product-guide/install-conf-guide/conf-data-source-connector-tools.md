...
Las siguientes pestañas proporcionan instrucciones para configurar un conector en función de la configuración de Experience Manager Guides: Cloud Service o On-Premise.
...
**Instalar un conector de código abierto{#install-open-source-connector}**
