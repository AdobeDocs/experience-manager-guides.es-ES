...
7. [Configurar sugerencias inteligentes en el perfil de carpeta](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring)
...
Para obtener más información, consulte [Configurar sugerencias inteligentes en el perfil de carpeta](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring).
