...
Las siguientes pestañas proporcionan los requisitos previos necesarios según la configuración de Experience Manager Guides: Cloud Service o On-Premise.
...
Las siguientes pestañas proporcionan instrucciones para la instalación de paquetes en función de la configuración de Experience Manager Guides: Cloud Service o On-Premise.
...
## Crear sitio con plantillas instaladas (para Cloud Service)
...
2. **Configurar ajuste preestablecido del sitio de AEM:** Hay dos opciones para configurar el sitio predeterminado (OOTB):
   ...
   **Opción 2: usar la ruta del sitio**
   ...
   1. Establezca la **ruta del sitio** manualmente como `/content/AEMG-Docs-Site/en/docs/product` para Cloud Service y `/content/aemg-docs/en/docs/product1` para On-Premise.
...
1. **Generar sitio:**
   ...
   2. El sitio generado estará disponible en la ruta: `/content/AEMG-Docs-Site/en/docs/product` para Cloud Service y `/content/aemg-docs/en/docs/product1` para On-Premise.
