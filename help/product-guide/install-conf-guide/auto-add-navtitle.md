...
Las siguientes pestañas proporcionan instrucciones para incluir el atributo `@navtitle` de forma predeterminada en las propiedades de los archivos de referencia en función de la configuración de Experience Manager Guides: Cloud Service o Local.
