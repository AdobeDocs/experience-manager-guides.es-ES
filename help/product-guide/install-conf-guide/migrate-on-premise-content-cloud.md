...
* Experience Manager Guides debe estar en la versión UUID. Si utiliza una versión de Adobe Experience Manager Guides que no es UUID, primero migre a UUID siguiendo los pasos de [Migrar contenido que no sea DITA](../install-conf-guide/uuid-non-uuid.md).
