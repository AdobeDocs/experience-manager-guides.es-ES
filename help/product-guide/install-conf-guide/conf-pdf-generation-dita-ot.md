...
Después de realizar los pasos anteriores, si elige el mismo perfil de carpeta en Preferencias de usuario en el Editor, verá la opción de generación de PDF en el modo de vista previa de un tema.
