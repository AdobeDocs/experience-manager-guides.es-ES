...
AEM Guides está disponible a través del Portal de distribución de software de Adobe. Puede descargar AEM Guides desde su cuenta de Adobe Software Distribution Portal e instalarlo en todas las instancias de Adobe Experience Manager (AEM) de la configuración. Normalmente, la instancia de creación y la instancia de producción de AEM se alojarán en diferentes servidores. Tendrá que instalar AEM Guides en todas las instancias de AEM que desee utilizar.

Antes de instalar Adobe Experience Manager Guides para instalación local, asegúrese de que su sistema cumpla los requisitos técnicos que se mencionan a continuación para la versión determinada.
...
>[!NOTE]
>
> Obtenga más información sobre las [versiones de Experience Manager Guides y descargue la compilación](../release-info/latest-release-info.md).
...
| **AEM Guides 4.4.0** | **No UUID y UUID 4.4.0** <ul><li> AEM 6.5 SP20, SP19, SP18 o SP17 <br> <li> Java: 11 u 8 <br><li>Sistemas operativos: <ul><li> Windows Server 2012 R2 <br> <li>Red Hat Linux 7 y 6</ul> |
