...
Las siguientes pestañas proporcionan instrucciones para configurar la plantilla de mapa DITA personalizada en función de la configuración de Experience Manager Guides: Cloud Service o Local.
...
## Personalización del número de referencias en un mapa DITA (sólo para Cloud Service)
