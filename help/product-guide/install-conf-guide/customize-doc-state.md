...
Las siguientes pestañas proporcionan instrucciones para automatizar el cambio de estado del documento en función de la configuración de Experience Manager Guides: Cloud Service o On-Premise.
...
AEM Guides proporciona un flujo de trabajo de aprobación de documentos, que le ayuda a controlar el ciclo de vida del proceso de desarrollo de documentos.

Las siguientes pestañas proporcionan instrucciones para habilitar el flujo de trabajo de aprobación en función de la configuración de Experience Manager Guides: Cloud Service o Local.
