...
> * Si utiliza una versión anterior a la 4.3.1, actualice a la versión 4.3.1. Siga las [instrucciones de actualización](./upgrade-aemg-latest-version.md) específicas de la versión con licencia del producto.
