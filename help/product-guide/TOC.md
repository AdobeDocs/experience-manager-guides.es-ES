...
- Base de conocimiento {#knowledge-base}
   ...
   - Sesión de expertos {#expert-session}
      ...
      - [AEM Variaciones de salida del sitio](./knowledge-base/expert-sessions/aem-site-output-variations-jun2024.md)
   - Artículos {#kb-articles}
      ...
      - Creación {#authoring}
         - Editor web {#webeditor}
            ...
            - [Uso de Markdown en AEM Guides](./knowledge-base/kb-articles/authoring/webeditor/mardown-in-DITA-and-AEM-Guides.md)
