...
En el editor web, se han organizado las siguientes configuraciones en las pestañas **General** y **Artículos**. También puede establecer la configuración de la **Base de conocimiento** específica que ha seleccionado como destino, **Adobe Experience Manager**, **Salesforce** o **ServiceNow**.
...
| Categoría | Seleccione una categoría del menú desplegable para publicar los temas del índice de esa categoría en el sitio de Adobe Experience Manager. |
