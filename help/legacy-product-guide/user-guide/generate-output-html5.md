---
title: Usar HTML5
description: Aprenda a crear un ajuste preestablecido de HTML5 desde el editor web y el panel de asignaciones. Configure el ajuste preestablecido de salida HTML5 en AEM Guides.
feature: Publishing
role: User
hide: true
