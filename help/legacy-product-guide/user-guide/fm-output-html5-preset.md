...
>[!NOTE]
>
> Para abrir los ajustes preestablecidos de salida de HTML5, haga clic en un archivo de FrameMaker \(`.fm` o `.book`\), a continuación, haga clic en Ajustes preestablecidos de salida y, por último, haga clic en la opción HTML 5.
