...
**Filtrar comentarios**: puede filtrar comentarios en un documento para ver comentarios específicos según sea necesario. Para filtrar comentarios, haga clic en el icono **Filter** \(![](images/filter-search-icon.svg)\) que aparece en el menú a la derecha del cuadro de texto Buscar comentarios del panel Comentarios.
