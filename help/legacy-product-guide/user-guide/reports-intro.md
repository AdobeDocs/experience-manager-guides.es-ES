...
En una configuración organizativa, debe verificar la integridad general de la documentación técnica antes de empezar a trabajar en ella o publicar los documentos. Esta necesidad se vuelve aún más esencial en entornos multiusuario y a gran escala. AEM Guides proporciona algunos informes que proporcionan una insight útil sobre el estado general del contenido del repositorio y cómo se utiliza el contenido en el proceso de documentación.
